...
exports.LoadUtils = () => {
    ...
    window.WWebJS.sendMessage = async (chat, content, options = {}) => {
        ...
        const message = {
            ...
            type: 'chat',
            ...ephemeralFields,
            // NOTE: não fazer spread direto do modelo mediaOptions (props próprias
            // como uploadhash/clientUrl/__x_* quebram a alocação de mídia do WA Web:
            // "Data passed to getter must include an id property"). Usar só o toJSON.
            ...(mediaOptions.toJSON ? mediaOptions.toJSON() : {}),
            ...(mediaOptions.caption !== undefined
                ? { caption: mediaOptions.caption }
                : {}),
            ...(mediaOptions.isViewOnce !== undefined
